...
func gcpServiceCatalog() []serviceCatalogEntry {
	return []serviceCatalogEntry{
		...
		},
		{
			...
			Detail:   "Lists Cloud Functions for the open gcloud configuration and project. Invoke and lifecycle actions follow in a later release.",
			Category: workspaceTabCategoryService, Domain: serviceDomainCompute,
			InventoryScope: "gcf",
		},
		{
			...
			Detail:   "Lists Google Kubernetes Engine clusters for the open gcloud configuration and project. Node pool and credentials actions follow in a later release.",
			Category: workspaceTabCategoryService, Domain: serviceDomainCompute,
			InventoryScope: "gke",
		},
	}
