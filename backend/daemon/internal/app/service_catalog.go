	...
	return []serviceCatalogEntry{
		{
			...
			Category: workspaceTabCategoryTool, InventoryScope: "logs",
		},
		{
			...
			Category: workspaceTabCategoryService, InventoryScope: "s3",
		},
		{
			...
			Category: workspaceTabCategoryService, InventoryScope: "ec2",
		},
		{
			...
			Category: workspaceTabCategoryService, InventoryScope: "lambda",
		},
		{
			...
			Category: workspaceTabCategoryService, InventoryScope: "dynamodb",
		},
		{
			...
			Category: workspaceTabCategoryService, InventoryScope: "sqs",
		},
		{
			...
			Category: workspaceTabCategoryService, InventoryScope: "sns",
		},
		{
			...
			Category: workspaceTabCategoryService, InventoryScope: "rds",
		},
		{
		...
		},
		{
			...
			Category: workspaceTabCategoryService, InventoryScope: "apigateway",
		},
		{
			...
			Category: workspaceTabCategoryService, InventoryScope: "secrets",
		},
		{
			...
			Category: workspaceTabCategoryService, InventoryScope: "iam",
		},
	}
}
...
func azureServiceCatalog() []serviceCatalogEntry {
	return []serviceCatalogEntry{
		...
		},
		{
			...
			Category: workspaceTabCategoryService, InventoryScope: "storage",
		},
		{
			...
			Category: workspaceTabCategoryService, InventoryScope: "webapps",
		},
		{
			...
			Category: workspaceTabCategoryService, InventoryScope: "functions",
		},
		{
			...
			Category: workspaceTabCategoryService, InventoryScope: "keyvault",
		},
		{
			...
			Category: workspaceTabCategoryService, InventoryScope: "cosmos",
		},
		{
			...
			Category: workspaceTabCategoryService, InventoryScope: "postgres",
		},
		{
			...
			Category: workspaceTabCategoryService, InventoryScope: "queues",
		},
		{
			...
			Category: workspaceTabCategoryService, InventoryScope: "entra",
		},
	}
}
