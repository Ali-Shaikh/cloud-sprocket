...
func main() {
	...
	service := app.New(settings, dataStore, discoveryService, s3Inventory, ec2Inventory, lambdaInventory, dynamodbInventory, sqsInventory, snsInventory, rdsInventory, ecsInventory, apigatewayInventory, logsInventory, iamInventory, azureInventory, dockerRuntime)
