...
**Latest release:** [v0.9.15](https://github.com/Ali-Shaikh/cloud-sprocket/releases/latest)
...
| Provider | Status |
|----------|--------|
| GCP | Live via gcloud CLI (Storage, Compute, Functions, GKE). Deeper IAM and SDK path is a v0.10 decision |
