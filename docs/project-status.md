...
**Latest release:** [v0.9.17](https://github.com/Ali-Shaikh/cloud-sprocket/releases/tag/v0.9.17)
**Recent releases:** v0.9.17 (Storage Queue send, SQS draft, region names), v0.9.16 (Azure inventory and WAF/Front Door dropdowns), v0.9.15 (Cosmos SQL query, DynamoDB Query-by-key)

**Post-v0.9.17 on `dev` (not yet released):** Labs SQS URL completeness and Lambda CloudWatch Logs (#415, CodeQL still open).
